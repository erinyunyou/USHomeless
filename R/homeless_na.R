#' Incompleted homeless counts (with missing values) and ACS variables
#'
#' Incompleted county-level homeless counts and selected demographic variables from American Community Survey (ACS). Homeless counts are from 2010 to 2014. ACS variables are five-year estimates from 2010 to 2014. This data set is used for imputation to get full homeless counts.
#'
#' @format A data frame with 3143 rows and 18 variables:
#' \describe{
