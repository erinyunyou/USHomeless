#' Completed homeless counts (missing values imputed) and ACS variables
#'
#' Completed county-level homeless counts (with missing values imputed) and selected demographic variables from American Community Survey (ACS). Homeless counts are from 2010 to 2014. ACS variables are five-year estimates from 2010 to 2014. The imputed homeless counts are generated from multiple imputation.
#'
#' @format A data frame with 3143 rows and 20 variables:
#' \describe{
#'   \item{state}{Two-digit state FIPS code.}
#'   \item{fips}{Five-digit FIPS county code which uniquely identifies counties and county equivalents in the United States.}
#'   \item{count14}{Homeless counts in 2014, missing values imputed.}
#'   \item{count13}{Homeless counts in 2013, missing values imputed.}
#'   \item{count12}{Homeless counts in 2012, missing values imputed.}
#'   \item{count11}{Homeless counts in 2011, missing values imputed.}
#'   \item{count10}{Homeless counts in 2010, missing values imputed.}
